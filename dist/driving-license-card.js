            ...
            <div class="section-content">
              <div class="info-grid">
                ...
                <div class="info-item">
                  ...
                  <!-- 修复2：移除颜色类，使用默认黑色 -->
                  <span class="info-value">${countdownInfo.text}</span>
                </div>
                <div class="info-item">
                ...
                <div class="info-item">
                  ...
                  <!-- 修复2：移除颜色类，使用默认黑色 -->
                  <span class="info-value">${pointsInfo.text} / 12分</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="section-content">
              <div class="info-grid">
                ...
                <div class="info-item">
                  ...
                  <!-- 修复2：移除颜色类，使用默认黑色 -->
                  <span class="info-value">${violationsCount}条未处理</span>
                </div>
              </div>
            </div>
          </div>
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .info-value {
          font-size: 14px;
          font-weight: 600;
          color: var(--primary-text-color, #333); /* 修复2：使用默认黑色 */
        }
