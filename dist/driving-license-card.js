        ...
        return `
          <div class="section">
            ...
            <div class="section-content">
              <div class="info-grid">
                <div class="info-item">
                  <span class="info-label black-text">有效期至</span>
                  <span class="info-value ${countdownInfo.color}">${expiryDate || '未知'}</span>
                </div>
                <div class="info-item">
                  <span class="info-label black-text">有效期倒计时</span>
                  <span class="info-value ${countdownInfo.color}">${countdownInfo.text}</span>
                </div>
                <div class="info-item">
                  <span class="info-label black-text">驾驶证状态</span>
                  <span class="info-value ${statusInfo.color}">${statusInfo.text}</span>
                </div>
                <div class="info-item">
                  <span class="info-label black-text">扣分情况</span>
        ...
        return `
          <div class="section">
            ...
            <div class="section-content">
              <div class="info-grid">
                <div class="info-item">
                  <span class="info-label black-text">年审日期</span>
                  <span class="info-value ${countdownInfo.color}">${inspectionDate || '未知'}</span>
                </div>
                <div class="info-item">
                  <span class="info-label black-text">年审倒计时</span>
                  <span class="info-value ${countdownInfo.color}">${countdownInfo.text}</span>
                </div>
                <div class="info-item">
                  <span class="info-label black-text">车辆状态</span>
                  <span class="info-value ${statusInfo.color}">${statusInfo.text}</span>
                </div>
                <div class="info-item">
                  <span class="info-label black-text">违章信息</span>
...
class DrivingLicenseEditor extends HTMLElement {
  ...
  console.log('Driving License Card with all fixes loaded successfully');